...
def generate_output_filename(
    ...
    Example:
        ...
        _working/output/20260109_153022.syllables.en_US.txt

        >>> # Without language code (backward compatible)
        >>> syllables_path, meta_path = generate_output_filename()
        >>> print(syllables_path)
        _working/output/20260109_153022.syllables.txt

    Note:
        Including the language code in filenames is useful when processing
        multiple files, making it easy to identify and organize language-specific
        syllable sets.
    """
